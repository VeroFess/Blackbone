...
typedef enum _WinVer
{
    ...
    WINVER_10_20H2 = 0x0A09, // April 2020 update 20H1
    WINVER_10_21H1 = 0x0A0A, // April 2020 update 20H1
    WINVER_10_21H2 = 0x0A0B, // April 2020 update 20H1
    WINVER_11_21H2 = 0x0B00, // April 2020 update 20H1
} WinVer;
